<article>
<h2>The Super Mouse</h2>
<p>
<img src="http://mrshoe.smugmug.com/Airplanes/N5779V/i-CqnX72r/0/L/IMG4728-L.jpg" />
</p>
<p>
&nbsp;&nbsp;&nbsp;&nbsp;On Friday, August 19, 2011, I took delivery of N5779V, a 1966 Beechcraft Musketeer Super III. This is my
first airplane. I bought it after about 25 hours of flight, while working toward my Private Pilot License.
</p>
<style>
table.manuals {
...
<p>
<script>
function update_cost(elem) {
	var hours;
	if ((hours = parseFloat(elem.value)) != undefined) {
		$('#monthlycost').text(((Math.min(hours, 6) * 140.0) + (Math.max(0, hours-6) * 90.0)).toFixed(0));
	}
}
</script>
The current rate is $140/hour wet tach, with a frequent flyer discounted rate of $90/hour that kicks in after
6 hours in one calendar month. Here's a handy calculator:<br /><br />
